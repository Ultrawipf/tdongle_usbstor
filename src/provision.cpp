...
bool provisionWriteDefaultConfig(const String &imageDir,
  ...
  f.print(
      ...
      "enabled   = true\n"
      "backlight = 200\n"
      "; Seconds without a button press before the screen switches off; 0\n"
      "; keeps it on. Host activity does not postpone it; the press that\n"
      "; wakes the screen is otherwise ignored.\n"
      "idle_timeout = 60\n"
      ...
      "[led]\n"
      "enabled    = true\n"
      "; 0..31, scales the APA102 current and the PWM value, so the curve is\n"
      "; steep: 4 is dim, 16 is bright, 31 is blinding.\n"
      "brightness = 4\n"
      "; Stay dark while the host has the volume mounted and idle. Access\n"
      "; blinks, errors, selection and maintenance are always shown.\n"
      "off_when_idle = true\n"
      "\n"
